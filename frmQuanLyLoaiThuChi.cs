    ...
    public partial class frmQuanLyLoaiThuChi : Form
    {
        ...
        private void LoadData()
        {
            ...
            try
            {
                ...
                dataGridView1.Columns["id_loai_tc"].HeaderText = "Mã Loại";
                dataGridView1.Columns["ten_loai"].HeaderText = "Tên Loại Thu Chi";
                dataGridView1.Columns["id_loai_tc"].AutoSizeMode = DataGridViewAutoSizeColumnMode.AllCells;
                dataGridView1.Columns["ten_loai"].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
        ...
        private void DataGridView1_SelectionChanged(object sender, EventArgs e)
        {
            if (dataGridView1.SelectedRows.Count > 0)
            {
                ...
                txtMaSV.Text = selected_id_loai_tc; // txtMaSV tương ứng với Mã loại
                textBox1.Text = row.Cells["ten_loai"].Value?.ToString(); // textBox1 tương ứng với Tên loại
            }
        }
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            SqlParameter[] parameters = {
                ...
                new SqlParameter("@ten", textBox1.Text.Trim())
            };
